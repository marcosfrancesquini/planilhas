...
----------------------------------------------------------------
Um único arquivo com menu para executar os 3 passos em sequência
ou individualmente.

Requisitos (mesmos dos seus scripts originais):
- Python 3.9+ recomendado
- pandas, numpy, xlsxwriter, openpyxl (e opcionalmente xlwings se usar --recalc-excel)

Saída padrão dos nomes na pipeline:
- TXT das primeiras N linhas: <stem>_primeiras_<N>.txt  (com números separados por vírgula)
- TXT da linha N+1:           <stem>_linha_<N+1>.txt    (com números separados por vírgula)
- Excel gerado:               Planilha_<N>.xlsx
- Excel ordenado:             ordenado<N>.xlsx
"""
